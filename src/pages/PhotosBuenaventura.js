...
const PhotosBuenaventura = (props) => {
  ...
  return (
    <>
      ...
      >
        <h1>Fotos Antiguas de Buenaventura</h1>
        <p>
          Esta es una colección de Fotos antiguas e
          históricas de Buenaventura. Bienvenidos a este viaje en el tiempo a
          ...
          Horst. License: Free access - rights reserved.
        </p>
        <Container>
          <ProductListToolbar />
...
export default PhotosBuenaventura;

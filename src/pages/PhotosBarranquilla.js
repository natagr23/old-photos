...
const PhotosBarranquilla = (props) => {
  ...
  return (
    <>
      ...
      >
        <h1>Fotos Antiguas de Barranquilla</h1>
        <p>
          Esta es una colección de Fotos antiguas e históricas de Barranquilla.
...
export default PhotosBarranquilla;

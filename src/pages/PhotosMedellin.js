...
const PhotosMedellin = (props) => {
  ...
  return (
    <>
      ...
      >
        <h1>Fotos Antiguas de Medellín</h1>
        <p>
          Esta es una colección de Fotos antiguas e históricas de Medellin.

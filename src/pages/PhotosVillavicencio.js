...
const PhotosVillavicencio = (props) => {
  ...
  return (
    <>
      ...
      >
        <h1>Fotos Antiguas de Villavicencio</h1>
        <p>
          Esta es una colección de Fotos antiguas e históricas de Villavicencio.
...
export default PhotosVillavicencio;
